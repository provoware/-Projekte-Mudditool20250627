...
-------------------------
Das zentrale Hauptfenster für Mudschikato – Struktur & Hilfstool 2025
- Alle Module laienfreundlich als Tab
- Dashboard als Startansicht
- Undo/Logging zentral verfügbar
- Theme-/Settings-Modul voll integriert
- Wiki-/Info-Modul voll integriert
...
class MainMudschikato(QMainWindow):
    def __init__(self):
        ...
        # Menüleiste: Undo, Dashboard, Einstellungen, Info, Exit
